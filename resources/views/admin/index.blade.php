  ...
  <div class="container-fluid position-relative px-7">
    <div class="row min-vh-75 mt-8 cols">
      <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 btn-group mb-5 d-flex justify-content-center px-md-4 px-lg-9">
        ...
        <a href="#" class="col btn btn-lg btn-primary">4. Kirim Surat BP</a>
      </div>
    ...
    <div class="row flex-center">
      <div class="col-auto">
        <ul class="list-unstyled list-inline">
          <li class="list-inline-item me-3"><a target="_blank" class="text-decoration-none" href="https://www.youtube.com/channel/UCjx4LnckEmsvkifJdY4bF7Q">
          ...
          <li class="list-inline-item me-3"><a target="_blank" class="text-decoration-none" href="https://www.facebook.com/perpustakaanITS/?ref=bookmarks">
          ...
          <li class="list-inline-item me-3"><a target="_blank" href="https://twitter.com/perpustakaanits">
          ...
          <li class="list-inline-item me-3"><a target="_blank" href="https://www.instagram.com/its.library/">
